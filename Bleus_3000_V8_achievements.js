...
(() => {
  ...
  function current(){return items.find(x=>x.id===editingId)||{label_text:'',icon_text:'🏅',appearance:{},icon_image_path:null,icon_storage_path:null};}
  ...
  async function save(e){
    ...
    try{
      ...
      const payload={label_text:label,description_short:null,icon_storage_path:storage,updated_at:new Date().toISOString()};
