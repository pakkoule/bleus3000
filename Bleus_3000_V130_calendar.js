/* 3615 Bleus V1.1.61.16 — lieu dans date · recherche calendrier · édition large */
(()=>{
  'use strict';
  const state={matches:[],mode:'upcoming',team:'all',search:'',canEdit:false,live:new Map(),liveTimer:null,selections:[],competitions:[],homePage:1,homePageSize:4,featureStyle:null,pinBusy:false,sheetSyncBusy:false,lastSheetSyncAt:0};
