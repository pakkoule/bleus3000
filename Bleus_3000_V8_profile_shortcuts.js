...
(() => {
  'use strict';
  const options=[
    {key:'internationaux',label:'Internationaux',icon:'👤',selector:'[data-reference-open="internationaux"]'},
  ...
  function ensureHost(){let h=document.getElementById('c3kProfileShortcuts');const rail=document.getElementById('c3kTopLeftRail');if(!rail)return null;if(!h){h=document.createElement('section');h.id='c3kProfileShortcuts';h.className='c3k-profile-shortcuts';rail.appendChild(h);}return h;}
